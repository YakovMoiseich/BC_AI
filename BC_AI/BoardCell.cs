...
namespace BC_AI {
    ...
    enum CellType {
        ...
        TANK_LEFT, OTHER_TANK_UP, OTHER_TANK_RIGHT, OTHER_TANK_DOWN, OTHER_TANK_LEFT
    }

	class BoardCell {

        static Dictionary<string, CellType> CharToCellType = new Dictionary<string, CellType> {
